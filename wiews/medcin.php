...
<img src="images/medecin.jpg" alt="" class="container">
  ...
  <br>
  <label for="medecin" class="mr-sm-2">specialite</label>

   <?php require_once'/opt/lampp/htdocs/projetmedicale/wiews/connexion.php'; 
$query=$conn->prepare('SELECT * FROM myspecialite');
$query->execute();
...
{ 
  ...
  ?>
 <select name=id >
 <option value="id"> <?php echo $data['id'];?></option>
  </select>
  <?php
  }
...
require_once'/opt/lampp/htdocs/projetmedicale/model/insmedcin.php';
